            ...
            <div class="intro-y box col-span-12 2xl:col-span-6">
                ...
                <div class="p-5">
                    <div class="boxed-tabs nav nav-tabs flex-col justify-center sm:flex-row text-gray-700 dark:text-gray-300" role="tablist">
                        <a id="section1-tab" data-toggle="tab" data-target="#section1" href="javascript:;" class="w-full sm:w-30 sm:h-30 mb-2 sm:mb-0 py-5 rounded-md box dark:bg-dark-5 text-center sm:mx-2 active" role="tab" aria-selected="true">
                            <i data-feather="box" class="block w-6 h-6 mb-2 mx-auto"></i> Section #1
                        </a>
                        <a id="section2-tab" data-toggle="tab" data-target="#section2" href="javascript:;" class="w-full sm:w-30 sm:h-30 mb-2 sm:mb-0 py-5 rounded-md box dark:bg-dark-5 text-center sm:mx-2" role="tab" aria-selected="false">
                            <i data-feather="inbox" class="block w-6 h-6 mb-2 mx-auto"></i> Section #2
                        </a>
                        <a id="section3-tab" data-toggle="tab" data-target="#section3" href="javascript:;" class="w-full sm:w-30 sm:h-30 mb-2 sm:mb-0 py-5 rounded-md box dark:bg-dark-5 text-center sm:mx-2" role="tab" aria-selected="false">
